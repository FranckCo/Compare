...
echo == M1.0: matching de deux fichiers ==

echo == DukeRunner ==
"%JAVA_HOME%\bin\java" -Xms128M -Xmx512M -Dfile.encoding=UTF-8 -classpath %COMPARE_CP% ps.pcbs.compare.duke.runners.LinkageRunner
