...
echo == M2.0: traitement pour doublon d'un fichier ==

echo == début du calcul empreinte de chaque ligne ==
"%JAVA_HOME%\bin\java" -Xms128M -Xmx512M -Dfile.encoding=UTF-8 -classpath %COMPARE_CP% ps.pcbs.compare.utils.DeduplicateCSV
